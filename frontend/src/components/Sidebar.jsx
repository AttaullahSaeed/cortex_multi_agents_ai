        ...
        <div className="flex-1 pt-5 overflow-y-auto px-2.5 pb-2 [scrollbar-width:none] [::-webkit-scrollbar]:hidden">
          {conversations?.map((conv, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex items-center justify-center shrink-0 w-[20px] h-[20px] rounded-lg transition-color duration-150 ${isActive ? "bg-indigo-500/15 text-indigo-400" : "bg-white/[0.05] text-slate-500"}`}
                >
    ...
    <div className="fixed lg:static inset-y-0 left-0 z-50 w-[270px] h-screen shrink-0 bg-[#0d0f14] border-r border-white/[0.06]">
      <div className="flex flex-col h-full">
        <div className="flex items-center gap-2.5 px-4 py-4 border-b border-white/[0.06]">
          ...
          <button
            onClick={handleCreateConversation}
            className="hidden md:flex items-center justify-center w-7 h-7 rounded-lg text-slate-500 hover:text-slate-200 hover:bg-white/[0.05] transition-colors duration-150 bg-transparent border-none cursor-pointer"
          >
            <PenSquare size={14} />
          </button>
        </div>
        <div className="px-4 pt-4 pb-1" onClick={handleCreateConversation}>
        ...
        <div className="flex-1 overflow-y-auto px-2.5 pb-2 [scrollbar-width:none] [::-webkit-scrollbar]:hidden">
          {conversations?.map((conv, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`flex items-center justify-center shrink-0 w-[28px] h-[28px] rounded-lg transition-color duration-150 ${isActive ? "bg-indigo-500/15 text-indigo-400" : "bg-white/[0.05] text-slate-500"}`}
                >
                  <MessageSquare size={13} />
                </div>
                <span
